...
// router.post('/register',auth.auth(), auth.restrictTo(["super_admin"]),  authController.register);
router.post('/login', validator.body(authValidation.login.body), authController.login);
    router.post('/logout', auth.auth(), auth.restrictTo(["super_admin", "admin"]),validator.body(authValidation.logout.body), authController.logout);
